...
public class FormLocation extends JFrame {
	...
	public FormLocation()
	{
		...
		JLabel lblInfo = new JLabel("ข้อมูลศูนย์ฉีด LO_DESC",SwingConstants.CENTER);
		...
		JLabel lblLO_ID = new JLabel("สถานที่ฉีด LO_DESC");
		lo_id = new JTextField();
		lo_id.setPreferredSize(new Dimension(200,30));

	
		JLabel lblLO_DESC = new JLabel("สถานที่ฉีด LO_DESC");
